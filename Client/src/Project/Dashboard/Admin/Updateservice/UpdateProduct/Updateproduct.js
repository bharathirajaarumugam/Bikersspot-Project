...
export function Updateproduct(){
    ...
    function handleupdate(event){
        ...
        if( Product_ImageAdderss === ''){
            ...
            axios.put("http://localhost:3005/updateproduct/"+productname.id,updatedetails)
            .then(res=>{
                    ...
                    <div class="container">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                                <div>
                                    <div>
                                        <h2 class="text-uppercase text-center mb-5">Update Bike Parts Order</h2>
                                        <form  onSubmit={handleupdate}>
                                            <div>
                                                <label className="text_color text-black"><b>Bike - Image Adderss</b></label>
                                            ...
                                            <div>
                                                <label className="text_color text-black"><b>Bike Model and product Name</b></label>
                                                <input type="text" id="Product_Name" value={productname.id} class="form-control" />
                                            </div>
                                            <div>
                                                <label className="text_color text-black"><b>Bike Part Price</b></label>
